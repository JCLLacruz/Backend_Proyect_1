	...
	async up(queryInterface, Sequelize) {
		return queryInterface.bulkInsert('Products', [
			{
				...
				image_url: `/public/images/user/products/charizard.png`,
				price: 500000,
				stock: 1,
				WarehouseId: 1,
		createdAt: new Date(),
		updatedAt: new Date(),
			},
			{
				...
				image_url: `/public/images/user/products/magikarp.png`,
				price: 10,
				stock: 300,
				WarehouseId: 1,
        createdAt: new Date(),
			...
			},
      {
				...
				image_url: `/public/images/user/products/pikachu.png`,
				price: 10000000,
				stock: 30,
				WarehouseId: 1,
        createdAt: new Date(),
			...
			},
      {
				...
				image_url: `/public/images/user/products/porygon.png`,
				price: 50000,
				stock: 30,
				WarehouseId: 1,
        createdAt: new Date(),
			...
			},
      {
				...
				image_url: `/public/images/user/products/slugma.png`,
				price: 50000,
				stock: 30,
				WarehouseId: 1,
        createdAt: new Date(),
